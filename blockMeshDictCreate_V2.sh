...
echo "    polyLine 5 4 ((-$d_c3 $d -$w_c2))" >> "$fileName"
echo "    polyLine 5 6 ((-$d_c3 -$d -$w_c2))" >> "$fileName"
echo "    polyLine 13 12 ((-$d_c3 $d $w_c2))" >> "$fileName"
echo "    polyLine 13 14 ((-$d_c3 -$d $w_c2))" >> "$fileName"
echo ");"       >> "$fileName"
